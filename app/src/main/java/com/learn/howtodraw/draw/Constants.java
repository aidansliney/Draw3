...
public class Constants {
    ...
    public static final String[] SKU_BOOK_NAME_ARRAY = {"book01", "book02", "book03", "book04", "book05"};
    ...
    public static final Integer[] SKU_BOOK_NAME_POINTER_ARRAY = {R.string.book01,R.string.book02,R.string.book03,R.string.book04,R.string.book05};
    public static final Integer[] SKU_BOOK_COVER_ARRAY = {R.drawable.book1cover,R.drawable.book2cover,R.drawable.book3cover,R.drawable.book4cover,R.drawable.book5cover};
